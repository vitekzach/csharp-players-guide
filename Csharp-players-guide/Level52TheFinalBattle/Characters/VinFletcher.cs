...
{
    public VinFletcher(IChooseActionInterface actionChooser, GearItem? startingGearItem = null)
        : base("VIN FLETCHER", actionChooser, new PunchAttack(), 15, startingGearItem) { }
}
